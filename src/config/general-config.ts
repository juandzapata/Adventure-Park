export namespace GeneralConfig {
  ...
  export const adminRolId = '633aedcc38f68246c4b8bcb7';
  export const carpetaArchivosAtracciones = '../../archivos/atracciones';
  export const carpetaArchivosZonas = '../../archivos/zonas';
